...
- ФИО (debtor/cedent/cessionary/recipient) — строго в именительном падеже, без префиксов "Гражданин РФ", "Гражданка РФ", "РФ": "Гражданин РФ Рябов А.В." -> "Рябов А.В.", "Лузиной Екатерине Александровне" -> "Лузина Екатерина Александровна".
